...
import io.github.luisrandomness.marcellomod.core.blocks.MM_OreBlock;
...
public class MM_Blocks {
    ...
    public static final RegistryObject<Block> RUISIUM_BLOCK = MM_Blocks.REGISTRY.register("ruisium_block",() -> new Block(Block.Properties.of(Material.HEAVY_METAL)
            .strength(20F,32F)
            .harvestLevel(3)
            .harvestTool(ToolType.PICKAXE)
            .requiresCorrectToolForDrops()
    ...
    public static final RegistryObject<MarcelloTypeBlock> RUISIUM_ORE = MM_Blocks.REGISTRY.register("ruisium_ore",() -> new MarcelloTypeBlock(Block.Properties.of(Material.STONE)
            .strength(8F,32F)
            .harvestLevel(3)
            .harvestTool(ToolType.PICKAXE)
            .requiresCorrectToolForDrops()
