package io.github.uncertainluei.mc.marcellomod.entity;

import io.github.uncertainluei.mc.marcellomod.init.MM_Items;
import io.github.uncertainluei.mc.marcellomod.init.MM_MobEffects;
import io.github.uncertainluei.mc.marcellomod.init.MM_SoundEvents;
import io.github.uncertainluei.mc.marcellomod.init.MM_Tags;
import io.github.uncertainluei.mc.marcellomod.item.BlockButtonItem;
...
public class MarkEntity extends Monster {
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {
        ...
        if (getItemInHand(InteractionHand.OFF_HAND).isEmpty() && random.nextInt(0,3) < difficulty.getDifficulty().getId())
    ...
    @Override
    protected @Nullable SoundEvent getAmbientSound() { return MM_SoundEvents.ENTITY_MARK_AMBIENT; }
