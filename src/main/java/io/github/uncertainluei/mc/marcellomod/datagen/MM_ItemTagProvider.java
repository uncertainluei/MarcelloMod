...
import io.github.uncertainluei.mc.marcellomod.MarcelloModDataGenerator;
...
public class MM_ItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        getOrCreateTagBuilder(ItemTags.LEG_ARMOR).add(MM_Items.RUISIUM_LEGGINGS);
        getOrCreateTagBuilder(ItemTags.FOOT_ARMOR).add(MM_Items.RUISIUM_BOOTS);
        ...
        getOrCreateTagBuilder(MM_Tags.ITEM_ARMOR_BREACH_WEAPONS)
                .add(MM_Items.RUISIUM_SWORD)
                .add(MM_Items.RUISIUM_SHOVEL)
                .add(MM_Items.RUISIUM_PICKAXE)
                .add(MM_Items.RUISIUM_AXE)
                .add(MM_Items.RUISIUM_HOE);
