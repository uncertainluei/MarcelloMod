...
public class MM_Items {
    ...
    private static final HashMap<MarcelloItemGroup, ArrayList<Item>> ITEMGROUP_MAP = new HashMap<>();

    public static Item registerItem(String identifier, Item itm, MarcelloItemGroup tab)
    {
        Item result = Registry.register(BuiltInRegistries.ITEM, modIdentifier(identifier), itm);
        return addToItemList(itm, tab);
    }

    public static Item addToItemList(Item itm, MarcelloItemGroup tab)
    {
        addToCreativeTab(itm, tab);
        return itm;
    }

    public static void addToCreativeTab(Item itm, MarcelloItemGroup tab)
    {
        if (tab == MarcelloItemGroup.NONE) return;

        if (!ITEMGROUP_MAP.containsKey(tab))
            ITEMGROUP_MAP.put(tab, new ArrayList<>());
        ITEMGROUP_MAP.get(tab).add(itm);
    }

    public static Item registerItem(String identifier, Item item)
    {
        return registerItem(identifier,item,MarcelloItemGroup.ITEMS);
    }
    ...
    public static final Item RUISIUM_SHARD = registerItem("ruisium_shard", new Item(new Item.Properties().rarity(Rarity.RARE)));
    public static final Item RUISIUM_INGOT = registerItem("ruisium_ingot", new Item(new Item.Properties().rarity(Rarity.RARE)));
    ...
    public static final Item OTHERWORLDLY_PHONE = registerItem ("otherworldly_phone", new Item(new Item.Properties().stacksTo(1).durability(64).rarity(Rarity.UNCOMMON)));
    ...
    public static final Item RUISIUM_SWORD = registerItem ("ruisium_sword", new SwordItem(MM_ToolTier.RUISIUM, new Item.Properties().rarity(Rarity.RARE).attributes(SwordItem.createAttributes(MM_ToolTier.RUISIUM, 3, -2.6F))));
    public static final Item RUISIUM_SHOVEL = registerItem ("ruisium_shovel", new ShovelItem(MM_ToolTier.RUISIUM, new Item.Properties().rarity(Rarity.RARE).attributes(ShovelItem.createAttributes(MM_ToolTier.RUISIUM, 1.5F, -3.1F))));
    public static final Item RUISIUM_PICKAXE = registerItem ("ruisium_pickaxe", new PickaxeItem(MM_ToolTier.RUISIUM, new Item.Properties().rarity(Rarity.RARE).attributes(PickaxeItem.createAttributes(MM_ToolTier.RUISIUM, 1F, -3F))));
    public static final Item RUISIUM_AXE = registerItem ("ruisium_axe", new AxeItem(MM_ToolTier.RUISIUM, new Item.Properties().rarity(Rarity.RARE).attributes(AxeItem.createAttributes(MM_ToolTier.RUISIUM, 6F, -3.2F))));
    public static final Item RUISIUM_HOE = registerItem ("ruisium_hoe", new HoeItem(MM_ToolTier.RUISIUM, new Item.Properties().rarity(Rarity.RARE).attributes(HoeItem.createAttributes(MM_ToolTier.RUISIUM, -5, 0F))));

    public static final Item RUISIUM_BOW = registerItem("ruisium_bow", new RuisiumBowItem(MM_ToolTier.RUISIUM, new Item.Properties().rarity(Rarity.RARE)));

    public static final Item HAMMER_PENCIL = registerItem ("hammer_pencil", new Item(new Item.Properties().stacksTo(1).durability(64)));

    public static final ArmorItem RUISIUM_HELMET = (ArmorItem) registerItem("ruisium_helmet", new ArmorItem(MM_ArmorTiers.RUISIUM, ArmorItem.Type.HELMET, new Item.Properties().rarity(Rarity.RARE).durability(ArmorItem.Type.HELMET.getDurability(35))));
    public static final ArmorItem RUISIUM_CHESTPLATE = (ArmorItem) registerItem("ruisium_chestplate", new ArmorItem(MM_ArmorTiers.RUISIUM, ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.RARE).durability(ArmorItem.Type.CHESTPLATE.getDurability(35))));
    public static final ArmorItem RUISIUM_LEGGINGS = (ArmorItem) registerItem("ruisium_leggings", new ArmorItem(MM_ArmorTiers.RUISIUM, ArmorItem.Type.LEGGINGS, new Item.Properties().rarity(Rarity.RARE).durability(ArmorItem.Type.LEGGINGS.getDurability(35))));
    public static final ArmorItem RUISIUM_BOOTS = (ArmorItem) registerItem("ruisium_boots", new ArmorItem(MM_ArmorTiers.RUISIUM, ArmorItem.Type.BOOTS, new Item.Properties().rarity(Rarity.RARE).durability(ArmorItem.Type.BOOTS.getDurability(35))));
    ...
    public static final Item MARCELIUM_BOAT_ITEM = addToItemList(TerraformBoatItemHelper.registerBoatItem(modIdentifier("marcelium_boat"), MARCELIUM_BOAT_KEY, false), MarcelloItemGroup.ITEMS);
    public static final Item MARCELIUM_CHEST_BOAT_ITEM = addToItemList(TerraformBoatItemHelper.registerBoatItem(modIdentifier("marcelium_chest_boat"), MARCELIUM_BOAT_KEY, true), MarcelloItemGroup.ITEMS);
    ...
    private static final CreativeModeTab TAB_BLOCKS = FabricItemGroup.builder()
            ...
            .displayItems((context, entries) -> {
                for (Item item : ITEMGROUP_MAP.get(MarcelloItemGroup.BLOCKS))
    ...
    private static final CreativeModeTab TAB_ITEMS = FabricItemGroup.builder()
            ...
            .displayItems((context, entries) -> {
                for (Item item : ITEMGROUP_MAP.get(MarcelloItemGroup.ITEMS))
                    if (!(item instanceof BlockItem))
                        entries.accept(item);
            })
            .build();
