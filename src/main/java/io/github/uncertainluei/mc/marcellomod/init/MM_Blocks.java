...
import io.github.uncertainluei.mc.marcellomod.world.MM_ConfiguredFeatures;
...
public class MM_Blocks {
    ...
    public static BlockItem getBlockItem(Block block)
    {
        ...
        MM_Items.addToCreativeTab(item, MM_Items.MarcelloItemGroup.BLOCKS);
        return item;
    }
    ...
    public static final BlockSetType BLOCKSET_SKIMELI = new BlockSetType("marcellomod:skimeli");
    public static final WoodType WOODTYPE_SKIMELI = new WoodType("marcellomod:skimeli",BLOCKSET_SKIMELI);
    
    public static final Block SKIMELI_LOG = registerBlock("skimeli_log", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final Block SKIMELI_WOOD = registerBlock("skimeli_wood", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final Block STRIPPED_SKIMELI_LOG = registerBlock("stripped_skimeli_log", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG)));
    public static final Block STRIPPED_SKIMELI_WOOD = registerBlock("stripped_skimeli_wood", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));

    public static final Block SKIMELI_PLANKS = registerBlock("skimeli_planks", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final Block SKIMELI_STAIRS = registerBlock("skimeli_stairs", new StairBlock(MM_Blocks.SKIMELI_PLANKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_STAIRS)));
    public static final Block SKIMELI_SLAB = registerBlock("skimeli_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SLAB)));
    public static final Block SKIMELI_FENCE = registerBlock("skimeli_fence", new FenceBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_FENCE)));
    public static final Block SKIMELI_FENCE_GATE = registerBlock("skimeli_fence_gate", new FenceGateBlock(WOODTYPE_SKIMELI,BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_FENCE_GATE)));
    public static final Block SKIMELI_PRESSURE_PLATE = registerBlock("skimeli_pressure_plate", new PressurePlateBlock(BLOCKSET_SKIMELI,BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PRESSURE_PLATE)));
    public static final Block SKIMELI_BUTTON = registerBlock("skimeli_button", new ButtonBlock(BLOCKSET_SKIMELI,30,BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_BUTTON)));
    ...
    public static final Block UNKNOWN_FLESH = registerBlock("unknown_flesh", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHERRACK)));
    ...
    public static final BlockFamily FAMILY_SKIMELI = BlockFamilies.familyBuilder(SKIMELI_PLANKS)
            .button(SKIMELI_BUTTON)
            .fence(SKIMELI_FENCE)
            .fenceGate(SKIMELI_FENCE_GATE)
            .pressurePlate(SKIMELI_PRESSURE_PLATE)
            .slab(SKIMELI_SLAB)
            .stairs(SKIMELI_STAIRS)
            .recipeGroupPrefix("wooden").recipeUnlockedBy("has_planks").getFamily();
